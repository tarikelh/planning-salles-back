...
class InterventionServiceImplTest {
	...
	public void beforeEach() throws Exception {
		...
		interventions.add(new Intervention(1, "I am lambda Intervention",
				mockedLoc,
				mockedCourse,
				mockedUser,
				InterventionStatus.SUR_MESURE,
				true,
				LocalDate.now(),
		...
		Intervention masterDummy = new Intervention(
				2,
				"I am a master Intervention",
				mockedLoc,
				mockedCourse,
				mockedUser,
				InterventionStatus.INTERN,
				true,
				LocalDate.now(),
				LocalDate.now().plusDays(5),
				true,
		...
		Intervention slaveDummy = new Intervention(
				3,
				"I am a slave Intervention",
				mockedLoc,
				mockedCourse,
				mockedUser,
				InterventionStatus.INTERN,
		...
		iDtos.add(new InterventionDto(3, "I am a slave Intervention", 3, 3, 3, "INTERN", true, LocalDate.now().plusDays(7),
	...
	void shouldGetInterventionsAndReturnDtos() {
		...
		mDtoTools.when(() -> DtoTools.convert(interventions.get(0), InterventionDto.class))
				.thenReturn(iDtos.get(0));
	...
	void shouldGetInterventionById() {
		...
		when(interventionRepository.findById(intervId))
	...
	@Test
	void shouldSaveNewSoloIntervention() throws Exception {
		Location mockedLoc = Mockito.mock(Location.class);
		Course mockedCourse = Mockito.mock(Course.class);
		User mockedUser = Mockito.mock(User.class);
		
		InterventionDto newIntervDto = new InterventionDto(0, "I am a New Intervention",
				3, 3, 3, "INTERN", true, LocalDate.now().plusDays(7),
				LocalDate.now().plusDays(10), 0, false, 0);
		
		Intervention newInterv = new Intervention(0, "I am a New Intervention",
				null, null, null, InterventionStatus.INTERN,
				true, LocalDate.now().plusDays(7), LocalDate.now().plusDays(10),
				false, null, 0);
		
		Intervention savedInterv = new Intervention(5, "I am a New Intervention",
				mockedLoc, mockedCourse, mockedUser, InterventionStatus.INTERN,
				true, LocalDate.now().plusDays(7), LocalDate.now().plusDays(10),
				false, null, 0);
		
		when(interventionService.checkIntegrity(newIntervDto)).thenReturn(true);
		
		mDtoTools.when(() -> DtoTools.convert(newIntervDto, Intervention.class))
				.thenReturn(newInterv);
		...
		doNothing().when(interventionService).saveMemento(newInterv);
	...
	void shouldSaveMasterIntervention() throws Exception {
		InterventionDto newIntervDto = new InterventionDto(0, "I am a New Master Intervention",
				0, 0, 0, "INTERN", true, LocalDate.now().plusDays(7),
				LocalDate.now().plusDays(10), 0, true, 0);
		
		Intervention newInterv = new Intervention(0, "I am a New Master Intervention",
				null, null, null, InterventionStatus.INTERN,
				true, LocalDate.now().plusDays(7), LocalDate.now().plusDays(10),
				false, null, 0);
		
		Intervention savedInterv = new Intervention(5, "I am a New Master Intervention",
				null, null, null, InterventionStatus.INTERN,
				true, LocalDate.now().plusDays(7), LocalDate.now().plusDays(10),
				false, null, 0);
		
		InterventionDto savedIntervDto = new InterventionDto(5, "I am a New Master Intervention",
				0, 0, 0, "INTERN", true, LocalDate.now().plusDays(7),
				LocalDate.now().plusDays(10), 0, true, 0);
		...
		mDtoTools.when(() -> DtoTools.convert(savedInterv, InterventionDto.class))
				.thenReturn(savedIntervDto);
