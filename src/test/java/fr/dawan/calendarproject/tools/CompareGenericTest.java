...
class CompareGenericTest {
	...
	void shouldCompareTwoObjects() throws Exception {
		Course newCourse1 = new Course(1, "Java course for beginners Updated", "5", "slug", 0);
		Course newCourse2 = new Course(1, "Java course for beginners", "3", "slug", 0);
		Course newCourse3 = new Course(1, "Java course for beginners Updated", "3", "slug", 0);
